    """
    Geo Lookup Api Xn1zz13
    ======================
    Lightweight Flask/FastAPI microservice to route HTTP traffic reliably.
    ...
    APP_NAME    = "Geo Lookup Api Xn1zz13"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight Flask/FastAPI microservice to route HTTP traffic reliably.")
